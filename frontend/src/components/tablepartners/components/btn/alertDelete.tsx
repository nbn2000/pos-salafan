...
import { useDeletePartnersMutation } from '@/api/partners';
...
export function DeleteAlertDialog({
  ...
  const [deletePartner] = useDeletePartnersMutation();
  ...
  const handleDelete = async () => {
    ...
    try {
      if (data.id === undefined) {
        throw new Error("Qarzdor ID noto'g'ri.");
      }

      await deletePartner(data.id).unwrap();
